...
void loop()
{
  ...
  if (IRLremote.available())
  {
    ...
    switch(data.command){
      case 0x19:
      Serial.println("deu certo! botão 0");
      break;
      
      case 0x45:
      Serial.println("deu certo! botão 1");
      break;

      case 0x46:
      Serial.println("deu certo! botão 2");
      break;

      case 0x47:
      Serial.println("deu certo! botão 3");
      break;

      case 0x44:
      Serial.println("deu certo! botão 4");
      break;

      case 0x40:
      Serial.println("deu certo! botão 5");
      break;

      case 0x43:
      Serial.println("deu certo! botão 6");
      break;

      case 0x7:
      Serial.println("deu certo! botão 7");
      break;

      case 0x15:
      Serial.println("deu certo! botão 8");
      break;  

      case 0x9:
      Serial.println("deu certo! botão 9");
      break;   
    }
  }
}
